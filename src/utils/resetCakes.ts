...
const cakeList = [
  {
    ...
    allergens: [allergensEnum.Lactosa, allergensEnum.Gluten, allergensEnum.Nuts],
  ...
  },
  {
    ...
    allergens: [allergensEnum.Lactosa, allergensEnum.Gluten],
  ...
  },
  {
    ...
    allergens: [allergensEnum.Lactosa, allergensEnum.Nuts, allergensEnum.Gluten],
  ...
  },
  {
    ...
    allergens: [allergensEnum.Lactosa],
  ...
  },
  {
    ...
    allergens: [allergensEnum.Lactosa, allergensEnum.Nuts],
